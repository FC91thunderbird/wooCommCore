            ...
            <ul id="menu" class="collapse">
                ...
                <li class="panel ">
                    <a href="#" data-parent="#menu" data-toggle="collapse" class="accordion-toggle" data-target="#component-nav">
                        <i class="icon-tasks"> </i> Order Management     
                    ...
                    <ul class="collapse" id="component-nav">
                        ...
                        <li class=""><a href="#"><i class="icon-angle-right"></i> Todays Order </a></li>
                         <li class=""><a href="#"><i class="icon-angle-right"></i> Pending Order </a></li>
                        <li class=""><a href="#"><i class="icon-angle-right"></i> Deliver Order </a></li>
                ...
                <li class="panel active">
                    <a href="category.php" >
                        <i class="icon-table"></i> Create Category
                    </a>                   
                </li>
                <li class="panel active">
                    <a href="subcategory.php" >
                        <i class="icon-table"></i> Sub Category
                    </a>                   
                </li>
                <li class="panel active">
                    <a href="insert_product.php" >
                        <i class="icon-table"></i> Insert Product
                    </a>                   
                </li>
                <li class="panel active">
                ...
                <li class="panel active">
                 ...
                 <li class="panel active">
                    <a href="logout.php" >
                        <i class="icon-table"></i> User Logout
                    </a>                   
                </li>
